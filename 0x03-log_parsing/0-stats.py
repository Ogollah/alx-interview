...
def extract_input(input_line):
    ...
    Args:
        input_line (str): The input line to extract information from.

    Returns:
        dict: A dictionary containing extracted
        information (status_code and file_size).
    """
    fp = (
        r'\s*(?P<ip>\S+)\s*',
...
def print_statistics(total_file_size, status_codes_stats):
    ...
    Args:
        ...
        status_codes_stats (dict): Dictionary
        containing status codes and their counts.
    """
